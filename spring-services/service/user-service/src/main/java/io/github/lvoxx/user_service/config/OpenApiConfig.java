...
/**
 * Cấu hình OpenAPI / Swagger UI cho user-service.
 *
 * <p>
...
public class OpenApiConfig {
        ...
        /**
         * Tạo OpenAPI bean với metadata đầy đủ cho user-service.
         *
        ...
        public OpenAPI openAPI() {
                return new OpenAPI()
                                .info(new Info()
                                                ...
                                                .description("REST API cho user-service — a part of SSSM Social Platform microservices.")
                                                .version("1.0.0")
                                                .contact(new Contact()
